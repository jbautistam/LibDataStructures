...
/// </summary>
public class NormalizedDictionary<TypeData>(bool replaceDuplicates = true) where TypeData : class
{
	/// <summary>
	///		Añade un elemmento
	/// </summary>
	...
	{
		NormalizedDictionary<TypeData> target = new();
	...
	{
		Dictionary<string, TypeData> converted = [];
	...
	///		Diccionario interno
	/// </summary>
	private Dictionary<string, TypeData> InternalDictionary { get; } = [];

	/// <summary>
	///		Reemplaza los duplicados
	/// </summary>
	public bool ReplaceDuplicates { get; set; } = replaceDuplicates;
}
